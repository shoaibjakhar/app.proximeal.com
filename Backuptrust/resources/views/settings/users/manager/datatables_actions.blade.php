{!! Form::open(['route' => ['users.manager.destroy', $id], 'method' => 'delete']) !!}
<div class='btn-group btn-group-sm'>
    {{-- <a data-toggle="tooltip" data-placement="bottom" title="{{trans('lang.user_edit')}}" href="{{ route('users.manager.edit', $id) }}" class='btn btn-link'>
        <i class="fa fa-eye"></i> 
    </a> --}}
    <a data-toggle="tooltip" data-placement="bottom" title="{{trans('lang.user_edit')}}" href="{{ route('users.manager.edit', $id) }}" class='btn btn-link'>
