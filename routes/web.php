...
Route::middleware('auth')->group(function () {
   ...
   // Route::get('send/{id}', 'MessageController@send')->name('send');
    Route::post('send', 'MessageController@send')->name('send');
    Route::post('pre_message', 'MessageController@pre_message')->name('pre_message');
    ...
    Route::resource('drivers', 'DriverController')->except([
      ...
      Route::get('requestedDrivers', 'DriverController@requestedDrivers')->name('requestedDrivers.index');
