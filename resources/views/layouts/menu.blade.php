...
@can('drivers.index')
    <li class="nav-item has-treeview">
        ...
        <ul class="nav nav-treeview">
            @can('users.driver.signups')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}" href="{!! route('requestedDrivers.index') !!}">@if($icons)
                    <i class="nav-icon fa fa-reorder"></i>@endif<p>{{trans('lang.driver_plural_requested')}}</p></a>
                </li>
            @endcan
            @can('drivers.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}" href="{!! route('drivers.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-reorder"></i>@endif<p>{{trans('lang.driver_plural')}}</p></a>
                </li>
            @endcan
...
@can('message.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('categories*') ? 'active' : '' }}" href="{!! route('message.index') !!}">@if($icons)
                <i class="nav-icon fa fa-comments"></i>@endif<p>{{trans('lang.message_plural')}}</p></a>
    </li>
@endcan
