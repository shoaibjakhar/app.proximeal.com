...
<div class="col-12 custom-field-container">
    ...
    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
        ...
        <div class="form-group row">
          <label for="sel1" class="col-3 control-label text-right" >Status</label>
       <select  name="status" class="form-control" style="width: 250px;">
        ...
        <option value="Declined" {{ $restaurant->status=="Declined" ? 'selected' :'' }}>Declined</option>
        <option value="objection" {{ $restaurant->status=="objection" ? 'selected' :'' }}>objection</option>
      </select>
    </div>
   <!--  <div class="form-group row ">
        {!! Form::label('status', trans("Status"),['class' => 'col-3 control-label text-right']) !!}
        <div class="checkbox icheck">
            <label class="col-9 ml-2 form-check-inline">
                {!! Form::hidden('decline', 0) !!}
                {!! Form::checkbox('decline', 1, null) !!}
            </label>
        </div>
    </div> -->
</div>
