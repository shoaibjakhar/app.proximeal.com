...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            ...
            <div class="form-text text-muted">{{ trans("lang.vehicle_type_help") }}</div>
        </div>
    </div>
...
<div class="form-group col-12 text-right">
    ...
    <a href="{!! route('users.driver.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
