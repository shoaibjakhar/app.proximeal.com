    ...
    public function boot()
    {
        ...
        try {
            ...
            config(['paypal.live.app_id' => setting('paypal_app_id')]);
               ...
               config([
                'services.flutter.privatekey' => setting('flutter_privatekey'),
            ]);
            config(['services.flutter.key' => setting('flutter_key')]);
            config([
                'services.flutter.paymethod' => setting('flutter_pay_method'),
            ]);
            config(['services.flutter.title' => setting('flutter_title')]);
            config([
                'services.flutter.description' => setting(
                    'flutter_description'
                ),
            ]);
            config(['services.flutter.logo' => setting('flutter_logo')]);

            config(['services.flutter.currency' =>setting('default_currency_code')]);
