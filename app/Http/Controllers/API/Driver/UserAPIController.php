...
class UserAPIController extends Controller
{
     ...
     * @return void
     */
    public function __construct(UserRepository $userRepository, UploadRepository $uploadRepository, RoleRepository $roleRepository, CustomFieldRepository $customFieldRepo,  RoleFolioRepository $roleFolioRepo)
    {
    ...
    function updateStatus($status, Request $request)
    {
        return "$request";
    }
}
